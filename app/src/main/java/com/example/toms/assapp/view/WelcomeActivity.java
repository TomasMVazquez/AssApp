...
import com.example.toms.assapp.view.adpater.MyPagerAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int position) {
                ...
                switch (position){
                    case 0:
                        welcome.setBackground(getDrawable(R.drawable.opening));
                        break;
                    case 1:
                        welcome.setBackground(getDrawable(R.drawable.slide2));
                        break;
                    case 2:
                        welcome.setBackground(getDrawable(R.drawable.slide3));
                        break;
                }
